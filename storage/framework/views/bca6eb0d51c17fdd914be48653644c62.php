...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'تسجيل الدخول | الخواجة'); ?></title>
...
<div class="grid min-h-screen lg:grid-cols-2">
    ...
    <div class="flex items-center justify-center p-5 sm:p-10">
        <div class="w-full max-w-md rounded-3xl border border-slate-800 bg-slate-900/90 p-7 shadow-2xl sm:p-9"><?php echo e($slot); ?></div>
    </div>
</div>
</body>
</html>
<?php /**PATH C:\Users\HP\Downloads\al-khawaja-final-v2-full\al-khawaja-delivery-full\resources\views/layouts/guest.blade.php ENDPATH**/ ?>